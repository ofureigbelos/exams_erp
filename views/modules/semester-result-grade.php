       ...
       <?php
          ...
          if(isset($_POST["search"])){
            ...
            if(isset($_POST["search"])){
              ...
              $query2 = "SELECT MatriculationNo, Total, schoolcourse.CourseUnit, schoolcourse.Department FROM courseregistration JOIN schoolcourse ON courseregistration.course_Id = schoolcourse.course_Id WHERE courseregistration.MatriculationNo = courseregistration.MatriculationNo AND Department = :dept AND Level = :leve AND Semester = :term AND Session = :year"; 
            ...
            <tbody>
              ...
              if($body != null){
                ...
                foreach($body as $row){
                  ...
                  if($row['Total'] < 40){
                    $grouped[$row['MatriculationNo']][] = 'E';
                  }elseif($row['Department'] == "PHN" && $row['Total'] >= 60){
                    $grd = 'B<sup>+</sup>';
                    $grouped[$row['MatriculationNo']][] = $grd;

                  }
                }
                foreach($body as $nrow){}
                  $i = 0;
